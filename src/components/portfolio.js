        ...
        <>
            <Parallax opacity={[2, -1]}  >
                <Link to='project' smooth={true} offset={-50}>
                    <h1 className="cursor-pointer hover:text-white ease-in-out duration-900 overflow-x-hidden py-6 text-4xl md:text-8xl font-bold text-gray-600 text-center pt-8 mb-8 lg:-mb-10">Projects</h1>
                </Link>
            </Parallax>
